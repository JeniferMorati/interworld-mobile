const dictionary = () => ({
  ...
  about: {
    ...
    aboutus: "Sobre nós",
    textaboutus:
      "Fundamos a Interworld em 2010 com o objetivo de oferecer não apenas intercâmbios, e sim projetos de vida. O projeto da Interworld começou pequeno, com apenas 5 integrantes e hoje contamos com mais de 100 profissionais para atender todas as necessidades de nossos alunos, com total dedição e comprometimento. Nossa meta é transformar o intercâmbio em uma experiência única na vida do intercambista e uma grande oportunidade profissional.",
    mission: "Missão",
    missionp:
      "Viabilizar intercâmbios culturais e viagens turísticas e de negócios adequados ao perfil de cada cliente, comprometendo-se com a qualidade de atendimento, inclusive durante a vivência internacional.",
    visionp:
      "Ser considerada a melhor empresa de intercâmbio cultural e turismo do Brasil e do mundo!",
    vision: "Visão",
    values: "Valores",
    valuesp:
      "Qualidade, seriedade, excelência, competência, ética, credibilidade e inovação.",
  },
  footer: {
    aboutUs:
  ...
  budgets: {
    ...
    email: "Email",
    phone: "Telefone",
    destinySearch: "Busque pelo país de destino",
